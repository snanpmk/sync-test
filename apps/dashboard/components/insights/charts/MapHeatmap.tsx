...
export default function MapHeatmap() {
    return (
        <div className="w-full h-full rounded-[32px] overflow-hidden group relative bg-white border border-neutral-100 shadow-inner">
            <style jsx global>{`
        .leaflet-control-attribution {
          display: none !important;
        }
        /* LIGHT THEME OPTIMIZATION: High contrast land with light background */
        .light-theme-map .leaflet-tile-pane {
